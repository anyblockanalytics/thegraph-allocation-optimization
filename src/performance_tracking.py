...
def calculateRewardsAllActiveAllocations(indexer_id, interval=1, initial_run=False):
...
def visualizeRewardActiveAllocationAllSubgraphsDetailed():
    ...
    fig = px.line(df, x='datetime', y=["reward_rate_hour"],
...
def visualizeRewardActiveAllocationAllSubgraphsCombined():
    ...
    fig = px.area(df, x='datetime', y=["reward_rate_hour", "reward_rate_hour_per_token", "accumulated_reward"],
